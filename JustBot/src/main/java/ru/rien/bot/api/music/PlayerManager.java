...
import ru.rien.bot.api.music.hooks.HookManager;
import ru.rien.bot.api.music.hooks.PlayerCreateHook;
...
public class PlayerManager {
    ...
    /**
     * Deletes a player manager. Use after logging a ru.rien.bot out or dropping a library.
     *
