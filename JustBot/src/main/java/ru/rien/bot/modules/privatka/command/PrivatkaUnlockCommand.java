...
public class PrivatkaUnlockCommand implements SubCommand {

    private PrivatkaService privatkaService;

    public PrivatkaUnlockCommand(PrivatkaService privatkaService){
        this.privatkaService = privatkaService;
    }

    @Override
    public SubcommandData getSubCommands() {
        return new SubcommandData("unlock", "users can join your room");
    }
    ...
    public void execute(CommandEvent event) {
        ...
        if(privatkaEntity != null){
            ...
            if(voiceChannel != null){
                ...
                MessageUtils.sendInfoMessage(MessageUtils.getEmbed(sender).setDescription("\uD83D\uDD12 Приватка разблокирована"), replyAction);
            }
        }else{
