...
//    }
    ...
    /**
     * Strip a message of all mentions, this is compatible with {@link net.dv8tion.jda.api.entities.Message#getContentDisplay()} and
     * {@link net.dv8tion.jda.api.entities.Message#getContentRaw()}.
     *
