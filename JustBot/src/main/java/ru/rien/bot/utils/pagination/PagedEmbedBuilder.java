...
public class PagedEmbedBuilder<T> {
    ...
    public class PagedEmbed {
        ...
        public MessageEmbed getEmbed(int page) {
            EmbedBuilder pageEmbed = new EmbedBuilder().setColor(Color.CYAN);
            if (title != null)
            ...
            if (pageCounts) {
                pageEmbed.addField("Страница", String.valueOf(page + 1), true);
                pageEmbed.addField("Всего", String.valueOf(pageTotal), true);
            }
