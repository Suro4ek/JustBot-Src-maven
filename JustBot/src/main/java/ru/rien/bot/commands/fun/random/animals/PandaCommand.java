...
@Component
public class PandaCommand implements Command {

    @Override
    public void execute(CommandEvent event) {
        try {
            HttpResponse<JsonNode> response = Unirest.get("https://some-random-api.ml/img/panda").asJson();
    ...
    public String getDescription(GuildWrapper guildWrapper) {
        return "Случайная панда";
    }

    @Override
    public String getUsage(GuildWrapper guildWrapper) {
        return "{%}panda - Случайная панда";
    }
    ...
    public Permission getPermission() {
        return Permission.PANDA_COMMAND;
    }
}
