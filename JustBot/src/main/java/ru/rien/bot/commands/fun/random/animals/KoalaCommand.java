...
@Component
public class KoalaCommand implements Command {

    @Override
    public void execute(CommandEvent event) {
        try {
            HttpResponse<JsonNode> response = Unirest.get("https://some-random-api.ml/img/koala").asJson();
    ...
    public String getDescription(Language guildWrapper) {
        return "Случайная коала";
    }

//    @Override
//    public String getUsage(GuildWrapper guildWrapper) {
//        return "{%}koala - Случайная коала";
//    }
    ...
    public Permission getPermission() {
        return Permission.KOALA_COMMAND;
    }
}
