...
public class SkipForceCommand implements SubCommand {

    private final ModuleDsBot moduleDsBot;

    public SkipForceCommand(ModuleDsBot moduleDsBot) {
        this.moduleDsBot = moduleDsBot;
    }

    @Override
    public SubcommandData getSubCommands() {
        return new SubcommandData("force", "пропустить трек");
    }
...
//                SongCommand.updateSongMessage(sender,guild, message, channel);
            ...
            MessageUtils.sendErrorMessage(guild.getMessage("NEED_PERMISSION",Permission.SKIP_FORCE), replyAction);
        }
    }
